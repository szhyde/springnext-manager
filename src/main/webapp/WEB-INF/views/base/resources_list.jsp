  ...
  <div class="row">
    <form id="searchForm" class="form-horizontal">
      <div class="row">
          ...
          <div class="controls">
            <input type="text" class="control-text" name="search_LIKE_url">
          </div>
        </div>
        <div class="control-group span8">
...
<div id="content" class="hide">
      <form id="save_Form" class="form-horizontal" action="${ctx}/resources/save" method="post">
        ...
        <div class="control-group span10">
          <label class="control-label">资源：</label>
          <div class="controls">
            <input type="text" class="control-text" name="url" data-rules="{required:true}" >
          </div>
        </div>
      </div>
        <div class="row">
    ...
    BUI.use(['common/search','bui/data','bui/overlay','bui/form'],function (Search,Data,Overlay,Form) {
        var enumObj = {"enable":"启用","disable":"禁用"},
          columns = [
			  {title : '资源',dataIndex :'url', width:100},
          ...
          store = Search.createStore('${ctx}/resources/search',{
              root:'data',
              totalProperty : 'total',
              pageSize:15,
              sortInfo : {
        ...
        function delItems(items){
          ...
          if(ids.length){
        	  BUI.Message.Confirm('确认要删除选中的记录么？',function(){
        		  $.ajax( {
        			      url:'${ctx}/resources/delete',// 跳转到 action 
        			      traditional:true,
        			      data:{'idList':ids},  
        			      type:'post',  
        			      cache:false,  
